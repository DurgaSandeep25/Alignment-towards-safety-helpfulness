...
class InputArgs:
    def __init__(self):
        self.model_name_or_path = "google/gemma-2b-it"
...
if __name__=="__main__":
    ...
    parser.add_argument("--model_name_or_path", type=str, default="google/gemma-2b-it", help="Model name or path")
    ...
    print(f"Accuracy: {compute_acc(actual_op, model_op)}")