"""
Following code is inherited from the https://github.com/vinid/safety-tuned-llamas/blob/main/evals/HarmfulnessRewardModel.py
and made little modifications to the code according  to our team requirements
"""
...
class AbsoluteHarmfulnessPredictor:
    def __init__(self, setup_name="redteam-osst", device=None):
        ...
        Args:
            setup_name (str): Name of the setup to use. Can be one of 'redteam' or 'redteam-osst'. Redteam uses a regression model fine-tuned on the RedTeam dataset. Redteam-osst uses a similar model but finetuned on the mix of RedTeam and OSST data.
        """
